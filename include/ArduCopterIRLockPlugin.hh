...
public:
  ...
  /// \brief Destructor
public:
  virtual ~ArduCopterIRLockPlugin();
...
public:
  virtual void Publish(const std::string &_fiducial, unsigned int _x, unsigned int _y);

  /// \internal
  /// \brief Pointer to private data.
private:
  std::unique_ptr<ArduCopterIRLockPluginPrivate> dataPtr;
};
}// namespace gazebo
#endif
